...
%   dens        Density [kg/m^3]
%
% Last modified:   2022/12/09   Meysam Mahooti
% 
%--------------------------------------------------------------------------
function dens = NRLMSISE_00(Mjd_UTC, r_ECEF, UT1_UTC, TT_UTC)
...
[year, month, day, hour, minute, sec] = InvMjday(Mjd_UTC);
...
input.f107 = sw_1(30);   % Daily F10.7 flux for previous day (observed).
